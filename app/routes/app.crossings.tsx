  ...
  const data = useLoaderData
    return (
      ...
      <div className="flex-1">
        <h1 className="font-semibold text-lg">Crossings</h1>
      </div>
        ...
        <DropdownMenu>
          ...
          <div className="border shadow-sm rounded-lg p-2 bg-white">
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">61.52</TableCell>
                  <TableCell>1st Street</TableCell>
                  <TableCell className="hidden md:table-cell">765143X</TableCell>
                  <TableCell className="text-right">XP4</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-medium">67.43</TableCell>
                  <TableCell>2nd Street</TableCell>
                  <TableCell className="hidden md:table-cell">765814B</TableCell>
                  <TableCell className="text-right">XP4</TableCell>
                  <TableCell className="hidden sm:table-cell">Active</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
